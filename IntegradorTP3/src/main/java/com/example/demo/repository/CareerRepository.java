...
//	@Query("SELECT new dto.DTOCareerByStudents(c.name, COUNT(c.name))"
//		+ " FROM Career c"
//		+ " JOIN c.students s"
//		+ " GROUP BY c.name"
...
//	@Query("SELECT new dto.DTOCareerByYear(c.idCareer, c.name, COUNT(sr.inscriptionDate), COUNT(sr.egressDate), year(sr.inscriptionDate))"
